...
const Special = ({match}) => {
    ...
    const summ = [
        (
            <h5 className="summ summ__title" style={{fontFamily: "anemone"}}>
                호국인물총서 2
    ...
    const htext1 = [
        ...
        (
            <div style={{color: "lightpink"}}>
                ...
                ‘6 <span style={{fontFamily: "nanum"}}> · </span> 25전쟁과 무공훈장-가슴에 단 명예’ 순회전시
            </div>
        ),
        (
            <div style={{color: "lightpink"}}>
                <span style={{fontFamily: "nanum"}}> ⑥ </span> 소중한 유물을 기증해주셔서 감사합니다(2020년 7~12월)
            </div>
        ),
        (
            <div style={{color: "lightpink"}}>
    ...
    const ex = [
        (
            <h5 className="summ" style={{fontFamily: "nanum-square"}}>
                전쟁기념관은 2021년 ‘이달의 호국인물’로 홍재근 육군일등병 등 12명을 선정했다. 특히 올해는 코로나19 관련, 기존의 대면 현양행사에 변화를 주어 온택트 시대에 부합하는 전시와 세미나, 영상 제작, 온라인 추모공간 신설 등 호국인물들의 공적과 숭고한 희생정신의 의미를 다양한 온오프라인 콘텐츠로 선보일 예정이다.
            </h5>
        )
    ]
            ...
            "contents": [
                {
                    ...
                    "images": news,
                    "htext": htext1[0],
                    "btext": "2020년 11월 26일 어린이박물관 옥상에 헬기 동산이 새롭게 조성되어 조촐한 개막식이 열렸다. " +
                ...
                },
                {
                    ...
                    "images": news3,
                    "htext": htext1[2],
                    "btext": "15회 차 영상으로 제작된 ‘죽음도 갈라놓지 못한 사랑’ 전시해설 콘텐츠는 3층 유엔실에 전시되어 있는 유엔군 묘지에 대한 이야기를 주제로, " +
                        "제목에서도 느낄 수 있듯이 애절한 부부의 사연을 담고 있다. 6·25전쟁에 참전했다가 전사한 호주 군인 케네스 존 휴머스턴 대위와 간호장교였던 그의 부인 낸시의 " +
                ...
                },
                {
                    ...
                    "images": news4,
                    "htext": htext1[3],
                    "btext": "전쟁기념관 온라인 콘텐츠 <유물을 만나다> 제3탄은 故 이건희 회장 기증 권총 영상을 제작하여 좋은 반응을 얻고 있다." +
                ...
                },
                {
                    ...
                    "images": news5,
                    "htext": htext1[4],
                    "btext": "전쟁군사박물관 협력망 활성화를 위해 2020년 1월 제작한 이동전시모듈 ‘6·25전쟁과 무공훈장-가슴에 단 명예’는" +
                        " 12월 10일부터 2021년 1월 말까지 경남 창녕 박진전쟁기념관에서 전시된다. 무공훈장의 제정과 수여에 관련된 이야기부터 " +
                        "새로 발굴한 초기 무공훈장의 모습까지 만나볼 수 있는 이동전시모듈은 지난 1년 동안 협력망기관 4개 박물관을 대상으로 한 순회전시에서 많은 호평을 받았다. " +
                        "2021년에는 6·25전쟁 참전부대를 주제로 한 전시패널 1종이 추가되어 총 2종이 순회전시를 통해 좀 더 많은 기관으로부터 호응을 받을 것으로 기대된다."
                },
                {
                    "id": "6",
                    "images": news6,
            ...
            "contents": [
                {
                    ...
                    "images": tm,
                    "htext": "",
                    "btext": "전쟁기념관 호국인물총서 시리즈의 두 번째 권으로 『유방백세: 어둠 속에서도 눈감지 않은 사람들』이 발간되었다. 이는 2020년 봉오동·청산리전투 100주년을 기념하여, 암흑과도 같았던 일제강점기 속에서 독립을 위해 목숨 바쳐 투쟁한 호국인물 26명이 걸어간 위대한 발자취를 다루고 있다."

                },
                {
                    "id": "2",
                    "images": tm2,
                    "btext": "‘꽃다운 이름 백세토록 전하리’라는 뜻을 지닌 제2권의 제목 ‘유방백세(遺芳百世)’는 독립운동가들이 먼저 간 동지들을 떠올릴 때 종종 인용했던 표현이다. 1948년 김구가 직접 쓴 것으로 현재 효창공원 내 삼의사 묘 기단에 새겨져 있다. 네 글자는 한글자씩 각장의 맨 앞에 배치하여 " +
                        ...
                        "국내의 경우, 각종 고지도와 당시 신문기사, 현재의 표석 등 여러 자료를 활용하여 주요 공적을 입체적으로 확인할 수 있도록 했다. 국외의 경우, 익숙지 않은 중국 동북 지역의 지도 자료를 제시함으로써 어렴풋이 알고 있었던 항일독립전쟁의 모습을 한눈에 파악할 수 있도록 심혈을 기울였다."
                },
                {
                    "id": '3',
                    "images": tm3,
                    "btext": "1년 가까이 자료를 조사하고 공적을 연구하고 호국인물 한분 한분의 삶을 재조명하면서, 그들의 숭고한 희생 정신에 절로 고개가 숙여지고 감사했다. 모쪼록 이 책을 접하는 많은 사람이 호국인물들의 헌신과, 이를 바탕으로 오늘의 평화와 번영이 꽃피울 수 있었음을 기억해주었으면 한다."
                }
            ]
        },
        {
                                            ...
                                            <div key={i}>
                                                ...
                                                >
                                                    ...
                                                    <Container
                                                        // style={{width: "60%"}}
                                                    >
                                                        <p className="post-excerpt" style={{textAlign: "justify"}}>
                                                            {special.btext}
                                                        </p>
                                                    </Container>
