...
const Monthly = ({match}) => {
    ...
    const btext2 = (
        <p className="post-excerpt">
            명과 연결하여 후금에 적대적인 입장을 취하는 조선에 큰 불만을 가 졌던 후금의 집권자 홍타이지는 1627년 1월 8일 아민으로 하여금 조 선 침공에 나서게 했다.
            정묘호란이 시작된 것이다. 기병과 보병을 합 한 후금의 3만 5천여 명 병력이 1월 13일 압록강을 넘었다.
            선봉에는 강홍립, 박난영 등 조선 출신 장수들과 통역관도 함께했다. 후금은 조 선이 명나라를 도와 후금을 공격했다는 것.
    ...
    const btext3 = (
        <p className="post-excerpt">
            1636년(인조 14년) 4월 국세를 확장한 후금의 홍타이지(태종)는 스스 로 황제라 칭하고, 국호를 청(淸)으로, 수도를 심양에 정하였다.
            ...
            병력12만8천여명가 운데는 몽골족 3만과, 한족 2만이 포함되어 있었다. 12월 2일 심양 을출발한청나라군대는12월8일마부대가이끄는기병6천여명 이 별다른 저항을 받지 않고 얼어붙은 압록강을 건넜다. 병자호란의 시작이었다.
