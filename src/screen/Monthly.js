...
const Monthly = ({match}) => {
    ...
    const btext2 = (
        <p className="post-excerpt">
            ...
            명나라 장군 모문룡에 대 한 지원을 계속한다는 것, 누르하치가 사망했을 때 조선에서 조문 사절을 보내지 않았다는 것 등을 출병 이유로 들었다.
            ...
            명나라 정벌에 총력을 기울여야 하는 후금도 더 이상의 공격은 무리라고 판단했고, 162권7년 3월 형제 관계의 맹약을 맺은 후 철수하 였다.
            협상으로 전쟁은 일단 종결되었지만, 정묘호란 이후에도 후금 에 대한 강경책은 조정의 대세였다.
            이제껏 오랑캐라고 무시했던 후 금을 명나라와 동등하게 대우하여야 한다는 조처는 인조와 서인 정권의 입장과 맞지 않았다.
