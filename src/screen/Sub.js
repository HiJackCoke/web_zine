...
const Sub = ({match}) => {
    ...
    const btext7 = [
        (
            <div>
                1946년 1월, 미군정 아래에서 우리 군의 모태인 남조선국방경비대가 창설되었을 당시 우리에게 처음 지급된 소총은 다름 아닌 옛일본군 의 99식 보병총이었다. 이름조차도 일본식 연호를 따서 지어진 이 총은 1945년 8월 일본이 항복하면서 남기고 간 것을 지급한, 말그대로 ‘일제의 잔재’였다. 새로운 나라의 군인을 꿈꾸며 입대한 장병들은 일본황실의 상징인 국화 무늬만 겨우 갈아내어 없앤 총을 받아들고 국력의 미비함을 통감해야 했을 것이다.
                <br/>
                이렇듯 어려운 상황은 1948년 대한민국 정부 수립에 즈음하여 미국의 군사원조를 통해 개선되었다. 미국은 당시 주한미군이 보유하였 던 미국의 M1 소총을 국군에게 제공하기 시작했다. 이 소총은 제2차 세계대전 동안 당대 최고의 개인화기로 정평이 나있었다. 그러나 한국인 남성의 평균 신장이 겨우 160cm 초반에 머물던 당시, 길이가 110cm에 중량이 4.3kg이나 나가는 M1 소총은 우리에게 결코 편안한 총이 아니었다. 그럼에도 국군은 6·25전쟁을 통하여 미국으로부터 제공된 22만 6천 정의 M1 소총을 소중히 운용하였다. 수 많은 참전자와 교련수업의 기억을 간직한 옛 세대의 ‘에무왕’은 30여 년간 우리 군의 전투력의 원천이 되었다.
            </div>
        ),
        (
            <div>
                세월이 흘러 1965년, 국군은 창설 이래 최초의 해외 파병인 베트남전 쟁의 길에 올랐다. 파병된 장병들은 베트남의 정글 속에서 분전하였지만 그들이 휴대한 M1 소총은 이 새로운 전장에 맞지않는 낡은 무기가 되어 있었다. 상대인 북베트남군은 당시 소련과 중국으로부터 지원받은 AK-47 자동소총을 사용했는데, 크기가 작고 가벼우면서도 연발 사격이 가능한 이 총은 누가 보아도 우리의 소총보다 훌륭한 것이었다. 이처럼 최전선에서부터 구식 소총에 대한 불만이 제기됨에 따라, 우리 육군은 베트남 주둔 미군으로부터 그들 사이에서도 이제 막 두각을 드러내기 시작한 신형 자동소총, 즉 M16 소총을 1967년부터 지원받기 시작하였다. 나무 몸통의 소총에 익숙했던 병사들은 마치 SF영화에 나올 듯한 M16 소총의 외형과 성능에 감탄하였다. 육군은 베트남에 파병된 부대에서부터 빠르게 M16 소총을 갖추어나갔으며, 베트남전쟁이 끝난 1974년에는 아예 미국으로부터 면허 생산을 승인받아 M16A1 소총을 국내에서 제작하였다. 이는 우리나라가 대량 생산한 최초의 총기였다. 최근까지도 후방이나 교육부대에서 이따금 씩 볼 수 있었던, ‘대한민국’ 글자가 음각된 M16A1 소총은 모두 이러 한 방식으로 생산된 것이었다.
            </div>
        ),
        (
            <div>
                ...
                <br/>
                신형 소총의 설계는 1974년부터 1980년까지 장장 6년의 세월이 걸렸다. 처음엔 M16A1 소총을 비롯한 다양한 외국산 소총을 모방하는 식으로 시제품을 만들었지만 이러한 과정을 통해 소총의 원리에 대한 이해가 깊어지자 점차 독자적인 디자인이 나타났다. 소총의 외형은 당시 우리 장병들에게 익숙한 M16A1 소총을 참고하되, 내부는 AK- 47 소총과 비슷한 가스활대를 넣어 단순하면서도 신뢰성 높은 그들의 장점을덧붙였다. 여기에 산악기동과 진지 공사가 잦은 우리군의 특성을 고려해 개머리판을 접을 수 있게 하였다. 이처럼 독자성을 추구하는 와중에도 유사시 미군과 국군 사이에서 보급품을 교환할 수 있도록 상호간의 탄환과 탄알집이 호환되도록 설계하였다. 이것이 1984년 우리군의 신형 소총이자 최초의 독자 개발소총인 K2자동 소총이다.
            </div>
        ),
        (
            <div>
                우리 군에서 한 소총이 제식으로 사용되었던 기간을 각각 헤아려보면 M1소총이 약 30여년, M16자동소총이 10여년, K2자동소총이 30여 년에 이른다. 교체 주기를 생각해보면 지금이 차세대 소총을 논의하기에 최적의 시기라는 것을 짐작할 수 있다. 그렇다면 어쩌면 또 다시 수십년의 ‘임무’를 다하게될 차세대 소총은 어떤것이 나올까? 우리 소총의 미래는 아마도 현재의 모습과 크게 차이가 나지 않을것이다. 개인화기의 발전은 이미 20세기를 거치며 ‘절정’에 다다랐기 때 문에,소총자체의 혁신보다는 이를 운용하는 방법의 발전이 전세계적인 추세이기 때문이다. 이러한 맥락 속에서 2014년 첫 개발되어 현재 보급이 진행 중인 K2C1 소총은 우리 소총의 앞길을 예증한다고 볼 수 있다. 기본적으로는 K2 자동소총과 동일한 모델이되, 사수의 상황에 맞게 각종 광학장비와 손잡이 등을 달 수 있는 레일이 총 몸 곳곳에 추가되고 사수의 체형에따라 길이 조절이 가능한 개머리판이 제공된다. 우리가 맞추어나가야 하는 무기에서, 우리에게 맞춰 나가는 무기로 발전한 소총개발의 역사가 우리군의 발전상을 잘 요약하고 있다.
            </div>
        )
    ]
